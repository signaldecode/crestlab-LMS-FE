...
function getCopy(): MainSectionsCopy | null {
  const adminPage = getPageData('admin') as { mainSections?: MainSectionsCopy } | null;
...
export default function AdminMainSectionsPage(): JSX.Element {
  const copy = getCopy();
  const sections = getAdminExtraData().mainSections;
