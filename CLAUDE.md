# CLAUDE.md (Next.js + React + JavaScript · Lecture Platform Template)
...
│  │
│  │  ├─ courses
│  │  │  ├─ page.jsx                 # 강의 목록(검색/필터/정렬)
│  │  │  └─ [slug]
│  │  │     └─ page.jsx              # 강의 상세(SEO 핵심, 커리큘럼/후기/Q&A)
│  │
│  │  ├─ community
│  │  │  ├─ page.jsx                 # 커뮤니티 메인(탭/검색)
│  │  │  ├─ new
│  │  │  │  └─ page.jsx              # 글 작성
│  │  │  └─ [slug]
│  │  │     ├─ page.jsx              # 글 상세
...
│  │  │  └─ page.jsx                 # 장바구니
│  │  ├─ checkout
│  │  │  └─ page.jsx                 # 결제(쿠폰/포인트/결제수단)
│  │  ├─ order
│  │  │  └─ complete
│  │  │     └─ page.jsx              # 결제 완료
│  │
│  │  ├─ learn
│  │  │  ├─ page.jsx                 # 내 강의실(구매 강의/진행률/이어보기)
│  │  │  └─ [courseSlug]
│  │  │     └─ [lectureId]
│  │  │        └─ page.jsx           # ⭐ 강의 플레이어(이어보기/자막/노트/북마크)
│  │
│  │  ├─ account
│  │  │  ├─ page.jsx                 # 계정 메인(프로필/설정)
│  │  │  ├─ orders
│  │  │  │  └─ page.jsx              # 주문 내역
│  │  │  ├─ community
│  │  │  │  └─ page.jsx              # 내 커뮤니티 활동
│  │  │  └─ devices
│  │  │     └─ page.jsx              # (선택) 로그인 기기/동시접속 관리
│  │
│  │  ├─ auth
│  │  │  ├─ login
│  │  │  │  └─ page.jsx              # 로그인
...
│  │  │  │  └─ page.jsx              # 회원가입
│  │  │  └─ callback
│  │  │     └─ page.jsx              # (선택) 소셜 로그인 콜백
│  │
│  │  ├─ support
│  │  │  ├─ page.jsx                 # 고객센터(FAQ/공지)
│  │  │  └─ tickets
│  │  │     ├─ page.jsx              # 1:1 문의 목록
│  │  │     └─ new
│  │  │        └─ page.jsx           # 1:1 문의 작성
...
│  │  └─ payments
│  │     ├─ confirm
│  │     │  └─ route.js              # 결제 승인 처리(선택)
│  │     └─ webhook
│  │        └─ route.js              # 결제 웹훅(선택)
│  │
│  └─ providers.jsx                  # 전역 Provider(Zustand/Theme/Toasts)
│
├─ components
│  ├─ common
│  │  ├─ AppHeader.jsx
...
│  │  ├─ LoadingSpinner.jsx
│  │  ├─ ProfileImage.jsx
│  │  └─ VideoPlayerShell.jsx        # (중요) 플레이어 UI 컨테이너
│  │
│  ├─ containers
│  │  ├─ HomeHeroContainer.jsx
│  │  ├─ FeaturedCoursesContainer.jsx
...
│  │  ├─ LearnDashboardContainer.jsx
│  │  └─ LecturePlayerContainer.jsx
│  │
│  ├─ courses                        # ⭐ 강의 도메인 컴포넌트
│  │  ├─ CourseCard.jsx
│  │  ├─ CourseFilterBar.jsx
...
│  │  ├─ LectureSidebar.jsx
│  │  ├─ LectureTopBar.jsx
│  │  ├─ LectureTranscript.jsx       # 자막/스크립트
│  │  ├─ LectureNotes.jsx            # 노트
│  │  ├─ LectureBookmarks.jsx        # 북마크
│  │  ├─ LectureControls.jsx         # 배속/화질/다음강의 등
│  │  └─ ProgressMeter.jsx           # 진행률
│  │
│  ├─ community
│  │  ├─ CommunityPageShell.jsx
│  │  ├─ CommunityHeader.jsx
│  │  ├─ CommunityTabs.jsx
│  │  ├─ PostList.jsx
│  │  ├─ PostCard.jsx
...
│
├─ lib
│  ├─ data.js                        # mainData 로드/조회(findBySlug)
│  ├─ seo.js                         # Metadata + JSON-LD 생성기
│  ├─ api.js                         # fetch 래퍼/에러 처리
│  ├─ auth.js                        # 토큰/쿠키/세션 유틸
│  ├─ payments.js                    # 결제 유틸(금액계산/쿠폰검증)
│  └─ player.js                      # 플레이어 유틸(진행률/이어보기 저장 등)
│
├─ stores
│  ├─ useCourseStore.js
...
│
├─ config
│  ├─ env.js                         # 환경변수 안전 로드/검증(선택)
│  ├─ featureFlags.js                # 기능 플래그(선택)
│  └─ siteConfig.js                  # 사이트 이름/도메인/SEO 기본값
│
├─ public
│  ├─ favicon.ico
│  ├─ robots.txt
...
- `lib/`
  ...
  - `data.js`: mainData 로드/slug 조회(findCourseBySlug 등)
  - `seo.js`: Metadata API + JSON-LD 생성기
  - `api.js`: fetch 래퍼/에러 처리/엔드포인트 유틸(선택)
  - `auth.js`: 토큰/쿠키/세션 처리 유틸(선택)
	- `payments.js`: 금액 계산/쿠폰 검증/결제 흐름 유틸(선택)
	- `player.js`: 진행률/이어보기/학습도구(노트/북마크) 유틸(선택)
