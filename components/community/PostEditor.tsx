 ...
 * - 주제, 제목, 투표, 본문 입력 필드와 제출 버튼을 포함한다
 */
...
const toolbarButtons = [
  { group: 'format', items: ['기본', 'AI'] },
  { group: 'text', items: ['B', 'I', 'U'] },
  { group: 'color', items: ['A', 'A'] },
  { group: 'align', items: ['align-left', 'align-center'] },
  { group: 'list', items: ['list-ordered', 'list-unordered'] },
  { group: 'insert', items: ['hr', 'quote', 'image', 'table', 'video', 'link'] },
];
          ...
          <div className="post-editor__field">
            ...
            <div className="post-editor__toolbar">
              <div className="post-editor__toolbar-group">
                <select className="post-editor__toolbar-select" aria-label="글꼴 크기">
                  <option>기본</option>
                  <option>제목1</option>
                  <option>제목2</option>
                  <option>제목3</option>
              ...
              <div className="post-editor__toolbar-group">
                <button type="button" className="post-editor__toolbar-btn" aria-label="AI 도우미">AI</button>
              </div>
              <span className="post-editor__toolbar-divider" />
              <div className="post-editor__toolbar-group">
                <button type="button" className="post-editor__toolbar-btn" aria-label="굵게"><b>B</b></button>
                <button type="button" className="post-editor__toolbar-btn" aria-label="기울임"><i>I</i></button>
                <button type="button" className="post-editor__toolbar-btn" aria-label="밑줄"><u>U</u></button>
              </div>
              <span className="post-editor__toolbar-divider" />
              <div className="post-editor__toolbar-group">
                <button type="button" className="post-editor__toolbar-btn" aria-label="글자 색">
                  <span className="post-editor__toolbar-color" style={{ borderBottomColor: '#dc2626' }}>A</span>
                </button>
                <button type="button" className="post-editor__toolbar-btn" aria-label="배경 색">
                  <span className="post-editor__toolbar-color" style={{ borderBottomColor: '#2563eb' }}>A</span>
                </button>
              </div>
              <span className="post-editor__toolbar-divider" />
              <div className="post-editor__toolbar-group">
                <button type="button" className="post-editor__toolbar-btn" aria-label="왼쪽 정렬">
              ...
              <span className="post-editor__toolbar-divider" />
              <div className="post-editor__toolbar-group">
                <button type="button" className="post-editor__toolbar-btn" aria-label="순서 목록">
                ...
                <button type="button" className="post-editor__toolbar-btn" aria-label="비순서 목록">
              ...
              <span className="post-editor__toolbar-divider" />
              <div className="post-editor__toolbar-group">
                <button type="button" className="post-editor__toolbar-btn" aria-label="구분선">
                ...
                <button type="button" className="post-editor__toolbar-btn" aria-label="인용">
              ...
              <span className="post-editor__toolbar-divider" />
              <div className="post-editor__toolbar-group">
                <button type="button" className="post-editor__toolbar-btn" aria-label="이미지">
                ...
                <button type="button" className="post-editor__toolbar-btn" aria-label="표">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><rect x="2" y="2" width="12" height="12" rx="1" stroke="currentColor" strokeWidth="1.2" /><path d="M2 6h12M2 10h12M6 2v12M10 2v12" stroke="currentColor" strokeWidth="1" /></svg>
                </button>
                <button type="button" className="post-editor__toolbar-btn" aria-label="동영상">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><rect x="1.5" y="3" width="10" height="10" rx="1.5" stroke="currentColor" strokeWidth="1.2" /><path d="M11.5 6l3-1.5v7L11.5 10" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" /></svg>
                </button>
                <button type="button" className="post-editor__toolbar-btn" aria-label="링크">
